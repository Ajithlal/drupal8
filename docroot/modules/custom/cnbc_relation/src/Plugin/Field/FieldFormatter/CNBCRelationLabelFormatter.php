...
namespace Drupal\cnbc_relation\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'cnbc_relation_label' formatter.
 *
 * @FieldFormatter(
 ...
 * )
 */
class CNBCRelationLabelFormatter extends EntityReferenceLabelFormatter {
