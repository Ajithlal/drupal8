...
interface EntityCollectionManagerInterface {
   ...
   */
  public function addEntityToCollection(EntityCollectionInterface $entityCollection, $entity_id);
   ...
   */
  public function removeEntityFromCollection(EntityCollectionInterface $entityCollection, $entity_id);
